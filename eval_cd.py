...
def main():
    ...
    parser.add_argument('--print_models', default=True, type=bool, help='print models')

    # data
    parser.add_argument('--num_workers', default=6, type=int)
    parser.add_argument('--dataset', default='CDDataset', type=str)
    parser.add_argument('--data_name', default='autodl-LEVIR256', type=str) #要改
    ...
    parser.add_argument('--net_G', default='ReViT', type=str,
