...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
           ...
           'wide_resnet50_2', 'wide_resnet101_2', 'resnext18']
...
def conv3x3g(in_planes, out_planes, stride=1, groups=1):
    """3x3 convolution with padding"""
    return nn.Conv2d(in_planes, out_planes, kernel_size=3, stride=stride,
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        # self.conv1 = conv3x3g(inplanes, planes*2, stride)
        # self.bn1 = norm_layer(planes*2)
        # self.relu = nn.ReLU(inplace=True)
        # self.conv2 = conv3x3g(planes*2, planes, groups=groups)
        # self.bn2 = norm_layer(planes)
        #
...
def resnext18(pretrained=False, progress=True, **kwargs):
    ...
    return _resnet('resnext50_32x4d', BasicBlock, [2, 2, 2, 2],
