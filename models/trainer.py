...
from models.losses import cross_entropy, ce_dice
...
class CDTrainer():
    ...
    def _collect_running_batch_states(self):
        ...
        if np.mod(self.batch_id, 500) == 1:
            ...
            file_name = os.path.join(
                self.vis_dir, 'istrain_'+str(self.is_training)+'_'+'Epoch'+
                              str(self.epoch_id)+'_'+'Batch'+str(self.batch_id)+'.jpg')
    ...
    def _update_checkpoints(self):
        ...
        self.logger.write('Lastest model updated. Epoch_acc(mf1)=%.4f, Historical_best_acc=%.4f (at epoch %d)\n'
    ...
    def train_models(self):
        ...
        for self.epoch_id in range(self.epoch_to_start, self.max_num_epochs):
            ...
            # Iterate over data.
            self.logger.write('Learning Rate: %0.7f\n' % self.optimizer_G.param_groups[0]['lr'])
